...
;(function($){
    $.fn.box=function(options){
        ...
        return this.each(function(el) {
            ...
            $this.wrap("<div class='xg-wraper"+el+"'><div class='xg-container"+el+"'></div></div>").css({
                'position': 'absolute',
                'left': 0,
                'width':'99999px'
            });
            // 给包裹的最外层div添加样式
            $this.closest(".xg-wraper"+el+"").css({
                'position': 'relative',
                'width': wr_w,
                'margin': '0 auto 0',
                'overflow': 'hidden'
            ...
            // 插入按钮
            if(btn){
                $this.closest(".xg-container"+el+"").before("<a href='javascript:void(0);' id='xg-prev'>prev</a><a href='javascript:void(0);' id='xg-next'>next</a>");
            };
            // 给包裹的上一层div添加样式
            $this.closest(".xg-container"+el+"").css({
                'position': 'relative',
                'z-index': 22,
                'height': e_h,
                'width': e_w,
